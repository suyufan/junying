import { StandardDeviceAdapter } from '../base';
declare class Adapter4H5 extends StandardDeviceAdapter {
    constructor(props: any);
}
export declare const StandardDeviceAdapter4H5: (new (...props: any[]) => {
