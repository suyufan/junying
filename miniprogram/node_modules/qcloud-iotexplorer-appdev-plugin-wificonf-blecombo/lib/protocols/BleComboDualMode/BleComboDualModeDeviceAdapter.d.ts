...
declare class LLSyncDualModeDeviceAdapter extends LLSyncDeviceAdapter {
...
export declare class BleComboDualModeDeviceAdapterBase extends BleComboLLSyncDeviceAdapterBase {
    ...
    static injectOptions(options: DualModeDeviceAdapterOptions): void;
    _bleDeviceAdapter: LLSyncDualModeDeviceAdapter;
    constructor(props: any);
    toString(): string;
    get authorized(): boolean;
    authenticateConnection(params: any): Promise<never>;
    bindDevice(data: any): Promise<string>;
    unbindDevice(data: any): any;
    controlDevice(data: any): any;
    init(): Promise<any>;
}
